    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                adapter.insert(0, new Data("New Movie" + position, "Movie description", R.drawable.ic_action_movie));
                position++;
            }
        });
        ...
        recyclerView.addOnItemTouchListener(new CustomRVItemTouchListener(this, recyclerView, new Recycler_View_Adapter.RecyclerViewItemClickListener() {
            @Override
